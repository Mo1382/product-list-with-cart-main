const renderInitHtml = function () {
  const initialHTML = `
    <div class="order-confirmation-layout hide-el">
      <div class="order-confirmation-modal">
        <div class="order-confirmed-top">
          <div class="oredered-confiremed-icon">
            <svg
              width="48"
              height="48"
              viewBox="0 0 48 48"
          ...
          <div class="oredered-confiremed-title">Order Confirmed</div>
          <p class="oredered-confiremed-message">We hope you enjoy your food</p>
        </div>
        <div class="ordered-confiremed-items-list">
          <div class="cart-sum-price">
            <span>Order Total</span>
            <span id="modal-total-price" class="total-price">$28.00</span>
          </div>
        </div>

        <button id="submit-new-order-btn" class="primary-btn cta-btn-hover">
          Start New Order
        </button>
      </div>
    </div>
    <div class="main-container container px-0">
      <div class="row mx-0">
        <div class="main-left px-4 px-sm-0 col-12 col-sm-12 col-md-8 mx-0">
          <h2 class="category-title">Desserts</h2>
          <main class="cards-wrapper container-fluid mx-0 px-0">
            <div class="row gx-md-4 mx-0">
            </div>
          </main>
        </div>
        <div class="main-right col-12 col-sm-12 col-md-4 mx-0">
            ...
            <div class="cart-items">
              ...
              <div class="delivery-section">
                ...
                <span class="delivery-message"
                  >This is a carbon-neutral delivery</span
                >
              </div>
              <button class="primary-btn confirm-order-btn cta-btn-hover">
                Confirm Order
              </button>
            </div>
          </div>
